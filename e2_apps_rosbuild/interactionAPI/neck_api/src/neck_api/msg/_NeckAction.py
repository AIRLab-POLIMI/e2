"""autogenerated by genpy from neck_api/NeckAction.msg. Do not edit."""
import sys
...
class NeckAction(genpy.Message):
  _md5sum = "348d6412782900a7868b13583f380004"
  _type = "neck_api/NeckAction"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

NeckActionGoal action_goal
NeckActionResult action_result
NeckActionFeedback action_feedback

================================================================================
MSG: neck_api/NeckActionGoal
...
================================================================================
MSG: neck_api/NeckResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
#Result definition
int32 status

================================================================================
MSG: neck_api/NeckActionFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

Header header
actionlib_msgs/GoalStatus status
NeckFeedback feedback

================================================================================
MSG: neck_api/NeckFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
#Feedback definition
uint8 feedback
...
"""
  ...
  _slot_types = ['neck_api/NeckActionGoal','neck_api/NeckActionResult','neck_api/NeckActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NeckAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = neck_api.msg.NeckActionGoal()
      if self.action_result is None:
        self.action_result = neck_api.msg.NeckActionResult()
      if self.action_feedback is None:
        self.action_feedback = neck_api.msg.NeckActionFeedback()
    else:
      self.action_goal = neck_api.msg.NeckActionGoal()
      self.action_result = neck_api.msg.NeckActionResult()
      self.action_feedback = neck_api.msg.NeckActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_goal.goal.actionCode))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.actionCode,) = _struct_i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
