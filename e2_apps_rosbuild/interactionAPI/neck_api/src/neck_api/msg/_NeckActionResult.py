"""autogenerated by genpy from neck_api/NeckActionResult.msg. Do not edit."""
import sys
...
class NeckActionResult(genpy.Message):
  _md5sum = "9297369affac35d2e9175b6fdde27add"
  _type = "neck_api/NeckActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','neck_api/NeckResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NeckActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = neck_api.msg.NeckResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = neck_api.msg.NeckResult()
