"""autogenerated by genpy from head_api/HeadActionFeedback.msg. Do not edit."""
import sys
...
class HeadActionFeedback(genpy.Message):
  ...
  _type = "head_api/HeadActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','head_api/HeadFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = head_api.msg.HeadFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = head_api.msg.HeadFeedback()
