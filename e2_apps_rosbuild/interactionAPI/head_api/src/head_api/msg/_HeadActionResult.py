"""autogenerated by genpy from head_api/HeadActionResult.msg. Do not edit."""
import sys
...
class HeadActionResult(genpy.Message):
  ...
  _type = "head_api/HeadActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','head_api/HeadResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = head_api.msg.HeadResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = head_api.msg.HeadResult()
