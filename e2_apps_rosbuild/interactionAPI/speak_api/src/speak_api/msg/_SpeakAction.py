"""autogenerated by genpy from speak_api/SpeakAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import speak_api.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class SpeakAction(genpy.Message):
  _md5sum = "e0db67def0f49e0411f5f9c33ab229ee"
  _type = "speak_api/SpeakAction"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

SpeakActionGoal action_goal
SpeakActionResult action_result
SpeakActionFeedback action_feedback

================================================================================
MSG: speak_api/SpeakActionGoal
...
================================================================================
MSG: speak_api/SpeakActionResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
================================================================================
MSG: speak_api/SpeakResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
#Result definition
int32 status

================================================================================
MSG: speak_api/SpeakActionFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
"""
  ...
  _slot_types = ['speak_api/SpeakActionGoal','speak_api/SpeakActionResult','speak_api/SpeakActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SpeakAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = speak_api.msg.SpeakActionGoal()
      if self.action_result is None:
        self.action_result = speak_api.msg.SpeakActionResult()
      if self.action_feedback is None:
        self.action_feedback = speak_api.msg.SpeakActionFeedback()
    else:
      self.action_goal = speak_api.msg.SpeakActionGoal()
      self.action_result = speak_api.msg.SpeakActionResult()
      self.action_feedback = speak_api.msg.SpeakActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.language
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.speed
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.language = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.language = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.speed = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.speed = str[start:end]
      _x = self
      start = end
      end += 12
