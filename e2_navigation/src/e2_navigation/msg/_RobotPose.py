...
"""
  ...
  _slot_types = ['e2_navigation/Point','e2_navigation/Quaternion']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.position is None:
        self.position = e2_navigation.msg.Point()
      if self.orientation is None:
        self.orientation = e2_navigation.msg.Quaternion()
    else:
      self.position = e2_navigation.msg.Point()
      self.orientation = e2_navigation.msg.Quaternion()
